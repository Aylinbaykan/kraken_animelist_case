...
// in mikrogrup/test/features/anime_detail/data/anime_detail_repository_impl_test.dart.
...
/// A class which mocks [AnimeDetailService].
///
/// See the documentation for Mockito's code generation for more information.
class MockAnimeDetailService extends _i1.Mock
    implements _i3.AnimeDetailService {
  MockAnimeDetailService() {
  ...
  @override
  _i4.Future<_i2.Response<Map<String, dynamic>>> getAnimeDetail(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAnimeDetail,
          [id],
